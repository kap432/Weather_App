...
const feels_likeElement = document.getElementById('fle');
...
function fetchWeather(location) {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            feels_likeElement.textContent = `${Math.round(data.main.feels_like)}°C`;
         //descriptionElement.textContent = data.weather[0].description;
          ...
          //descriptionElement.textContent = weatherDescription.charAt(0).toUpperCase() + weatherDescription.slice(1);
            ...
            if (temp >= 10 && temp < 15) {
                ...
                temperatureElement.textContent = "Actual temperature: "+ `${Math.round(data.main.temp)}°C`;
                feels_likeElement.textContent="Feels Like: "+ `${Math.round(data.main.feels_like)}°C`;
